...
Card.create(name: "Обряд грома", rarity: "uncommon", card_url: "http://berserk.ru/image/data/Берсерк/gorii-531-copy.png", card_type: "creature", dropped_from_booster: true, card_set_id: set.id, rate: 4, cost: 3)
...
Card.create(name: "Предвидение", rarity: "common", card_url: "url", card_type: "creature", dropped_from_booster: true, card_set_id: set.id, rate: 3, cost: 1)
...
Card.create(name: "Разбомбить", rarity: "rare", card_url: "http://berserk.ru/image/data/Берсерк/multi520-copy.png", card_type: "creature", dropped_from_booster: true, card_set_id: set.id, rate: 3, cost: 5)
